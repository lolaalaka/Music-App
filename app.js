...
(function(){
    ...
    let ham = {
        ...
        // remove(){
        //     this.nav.classList.remove('expand');
        // }
...
let trackControl = [
    ...
    {   nameOfTrack: "MONDAY COMES",
        artistName:  "Late",
        imageUrl: "https://images.unsplash.com/photo-1548923429-355d6c561385?ixid=MXwxMjA3fDB8MHxzZWFyY2h8Mnx8YWxidW0lMjBjb3ZlciUyMGFydHxlbnwwfDF8MHxyZWQ%3D&ixlib=rb-1.2.1&auto=format&fit=crop&w=500&q=60",
